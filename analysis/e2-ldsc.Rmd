...
The original LDSC was written for Python 2, which reached end-of-life in January 2020. We recommend using the actively maintained Python 3 fork: [abdenlab/ldsc-python3](https://github.com/abdenlab/ldsc-python3).
...
# create a virtual environment for ldsc (python3)
cd ldsc-python3
conda env create --file environment.yml

# The Python 3 environment.yml uses:
name: ldsc
channels:
- defaults
- conda-forge
